...
public class PhuongPak {
    ...
    Permanent Address : different address
       */
        ...
        java.util.List<WebElement> allInformation = driver.findElements(By.xpath("//div[@class='border col-md-12 col-sm-12']"));

        java.util.List<String> actualInformation = new ArrayList<>();

        for (WebElement info : allInformation) {
            actualInformation.add(info.getText().trim());
        }
